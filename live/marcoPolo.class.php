...
/*
This class is adapted from backtest marcoPolo/marcoPolo-o.class.php
...
/*
			...
			"AUD_USD" => array(
				"acceptedLossPerTrade" => .02,
				"trendLookbackCandles" => 24*5,
				"trendRatioThreshold" => .51,
				"tradeLookbackCandles" => 24,
				"windowRatioThresholdSell" => .83,
				"windowRatioThresholdBuy" => .17,
				"tpMultiplier" => 6,
				"slMultiplier" => 1.25,
				"hedgeThreshold" => .8,
			),
